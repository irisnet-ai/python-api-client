...
**prototype** | **str** | The prototype that the classification object belongs to. Setting the prototype will specify the parameters for the classification belonging to the prototype. | [optional] 
...
**prototype_object** | [**AiPrototype**](AiPrototype.md) |  | [optional] 

...
class Pricing(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cost", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cost", ], str]):

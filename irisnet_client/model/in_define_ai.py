...
def lazy_import():
    ...
    globals()['INImage'] = INImage


class INDefineAI(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """INDefineAI - a model defined in OpenAPI

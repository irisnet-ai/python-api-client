...
class Event(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["classification", "group", "start", "duration", "severity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["classification", "group", "start", "duration", "severity", ], str]):

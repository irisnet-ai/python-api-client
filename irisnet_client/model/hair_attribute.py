...
class HairAttribute(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class style(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "longHaired": "LONG_HAIRED",
                        "shortHaired": "SHORT_HAIRED",
                    }
                
                @schemas.classproperty
                def LONG_HAIRED(cls):
                    return cls("longHaired")
                
                @schemas.classproperty
                def SHORT_HAIRED(cls):
                    return cls("shortHaired")
            __annotations__ = {
                "type": type,
                "color": color,
                "style": style,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "color", "style", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "color", "style", ], str]):

...
class ConfigurationManagementApi:
    ...
    def delete_config(
        self,
        config_id: Annotated[StrictStr, Field(description="The id of the configuration that should be deleted.")],
    ...
    def _delete_config_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v2/config/{configId}',
    ...
    def get_config(
        self,
        config_id: Annotated[StrictStr, Field(description="The id of the configuration that is being requested.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def set_config(
        self,
        config: Annotated[Config, Field(description="Define the prototypes to use for an AI check operation. View the _Config_ schema to see the available prototypes.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[

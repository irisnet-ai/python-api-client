...
class AICheckOperationsApi:
    ...
    def age_verification(
        ...
        biometric_check_request_data: Annotated[BiometricCheckRequestData, Field(description="The BiometricCheckRequestData containing data needed for the age verification check.")],
        ...
        :type config_id: str
        :param biometric_check_request_data: The BiometricCheckRequestData containing data needed for the age verification check. (required)
        :type biometric_check_request_data: BiometricCheckRequestData
        ...
        _param = self._age_verification_serialize(
            config_id=config_id,
            biometric_check_request_data=biometric_check_request_data,
    ...
    @validate_call
    def age_verification_with_http_info(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        biometric_check_request_data: Annotated[BiometricCheckRequestData, Field(description="The BiometricCheckRequestData containing data needed for the age verification check.")],
        _request_timeout: Union[
    ...
    @validate_call
    def age_verification_without_preload_content(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        biometric_check_request_data: Annotated[BiometricCheckRequestData, Field(description="The BiometricCheckRequestData containing data needed for the age verification check.")],
        _request_timeout: Union[
    ...
    def _age_verification_serialize(
        self,
        config_id,
        biometric_check_request_data,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if biometric_check_request_data is not None:
            _body_params = biometric_check_request_data
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/age-verification/{configId}',
    ...
    @validate_call
    def check_poa_document(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        poa_check_request_data: Annotated[PoaCheckRequestData, Field(description="The PoaCheckRequestData containing data needed for the proof of address check. The DocumentType in the request data must be either 'utility_bill' or 'bank_statement'.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param config_id: The configuration id from the Basic Configuration operations. (required)
        :type config_id: str
        :param poa_check_request_data: The PoaCheckRequestData containing data needed for the proof of address check. The DocumentType in the request data must be either 'utility_bill' or 'bank_statement'. (required)
        :type poa_check_request_data: PoaCheckRequestData
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._check_poa_document_serialize(
            config_id=config_id,
            poa_check_request_data=poa_check_request_data,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def check_poa_document_with_http_info(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        poa_check_request_data: Annotated[PoaCheckRequestData, Field(description="The PoaCheckRequestData containing data needed for the proof of address check. The DocumentType in the request data must be either 'utility_bill' or 'bank_statement'.")],
        _request_timeout: Union[
    ...
    @validate_call
    def check_poa_document_without_preload_content(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        poa_check_request_data: Annotated[PoaCheckRequestData, Field(description="The PoaCheckRequestData containing data needed for the proof of address check. The DocumentType in the request data must be either 'utility_bill' or 'bank_statement'.")],
        _request_timeout: Union[
    ...
    def _check_poa_document_serialize(
        self,
        config_id,
        ...
        # process the form parameters
        # process the body parameter
        if poa_check_request_data is not None:
            _body_params = poa_check_request_data
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/check-poa-document/{configId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def check_text(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        data: Annotated[Data, Field(description="The text that needs to be checked.")],
        detail: Annotated[Optional[Annotated[int, Field(le=3, strict=True, ge=0)]], Field(description="Set the detail level of the response.  * _1_ - The response only contains the _Summary_ and possibly the _Encoded_ schemas for basic information's (better API performance). * _2_ - Additionally lists all broken rules (_BrokenRule_ schema) according to the configuration parameters that were requested. * _3_ - Also shows detections (e.g. _BaseDetection_ schema) that contains extended features to each found object.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._check_text_serialize(
            config_id=config_id,
            data=data,
            detail=detail,
            _request_auth=_request_auth,
    ...
    @validate_call
    def check_text_without_preload_content(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        data: Annotated[Data, Field(description="The text that needs to be checked.")],
        detail: Annotated[Optional[Annotated[int, Field(le=3, strict=True, ge=0)]], Field(description="Set the detail level of the response.  * _1_ - The response only contains the _Summary_ and possibly the _Encoded_ schemas for basic information's (better API performance). * _2_ - Additionally lists all broken rules (_BrokenRule_ schema) according to the configuration parameters that were requested. * _3_ - Also shows detections (e.g. _BaseDetection_ schema) that contains extended features to each found object.")] = None,
    ...
    def _check_text_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/check-text/{configId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def face_authentication(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        biometric_check_request_data: Annotated[BiometricCheckRequestData, Field(description="The BiometricCheckRequestData containing data needed for the face authentication.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param config_id: The configuration id from the Basic Configuration operations. (required)
        :type config_id: str
        :param biometric_check_request_data: The BiometricCheckRequestData containing data needed for the face authentication. (required)
        :type biometric_check_request_data: BiometricCheckRequestData
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._face_authentication_serialize(
            config_id=config_id,
            biometric_check_request_data=biometric_check_request_data,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def face_authentication_with_http_info(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        biometric_check_request_data: Annotated[BiometricCheckRequestData, Field(description="The BiometricCheckRequestData containing data needed for the face authentication.")],
        _request_timeout: Union[
    ...
    @validate_call
    def face_authentication_without_preload_content(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        biometric_check_request_data: Annotated[BiometricCheckRequestData, Field(description="The BiometricCheckRequestData containing data needed for the face authentication.")],
        _request_timeout: Union[
    ...
    def _face_authentication_serialize(
        self,
        config_id,
        biometric_check_request_data,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/face-authentication/{configId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def live_document_check(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        live_document_check_request_data: Annotated[LiveDocumentCheckRequestData, Field(description="The LiveDocumentCheckRequestData containing data needed for the live id document check.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param config_id: The configuration id from the Basic Configuration operations. (required)
        :type config_id: str
        :param live_document_check_request_data: The LiveDocumentCheckRequestData containing data needed for the live id document check. (required)
        :type live_document_check_request_data: LiveDocumentCheckRequestData
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._live_document_check_serialize(
            config_id=config_id,
            live_document_check_request_data=live_document_check_request_data,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '202': "LiveDocumentCheckResponseData",
            '402': "ApiNotice",
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def live_document_check_with_http_info(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        live_document_check_request_data: Annotated[LiveDocumentCheckRequestData, Field(description="The LiveDocumentCheckRequestData containing data needed for the live id document check.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LiveDocumentCheckResponseData]:
        """Start a guided live id document check with the AI.
    ...
    @validate_call
    def live_document_check_without_preload_content(
        self,
        config_id: Annotated[StrictStr, Field(description="The configuration id from the Basic Configuration operations.")],
        live_document_check_request_data: Annotated[LiveDocumentCheckRequestData, Field(description="The LiveDocumentCheckRequestData containing data needed for the live id document check.")],
        _request_timeout: Union[
    ...
    def _live_document_check_serialize(
        self,
        config_id,
        live_document_check_request_data,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if live_document_check_request_data is not None:
            _body_params = live_document_check_request_data
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/check-live-id-document/{configId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

...
# body param
SchemaForRequestBodyApplicationJson = ParamSet


request_body_param_set = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _set_parameters_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_param_set.serialize(body, content_type)
...
class SetParameters(BaseApi):
    ...
    def set_parameters(
        ...
        return self._set_parameters_oapg(
            body=body,

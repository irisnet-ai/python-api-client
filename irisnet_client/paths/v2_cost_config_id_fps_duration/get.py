...
request_path_fps = api_client.PathParameter(
    name="fps",
    style=api_client.ParameterStyle.SIMPLE,
    schema=FpsSchema,
    required=True,
)
request_path_duration = api_client.PathParameter(
    name="duration",
    style=api_client.ParameterStyle.SIMPLE,
...
class GetVideoCost1(BaseApi):
    ...
    def get_video_cost1(
        ...
        return self._get_video_cost1_oapg(

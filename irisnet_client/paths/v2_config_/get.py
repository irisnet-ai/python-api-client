...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['Config']:
            return Config

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['Config'], typing.List['Config']],
...
class GetAllConfigs(BaseApi):
    ...
    def get_all_configs(
        ...
        return self._get_all_configs_oapg(

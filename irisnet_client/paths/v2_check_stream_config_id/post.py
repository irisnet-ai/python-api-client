...
# Query params
InUrlSchema = schemas.StrSchema
OutUrlSchema = schemas.StrSchema


class CycleLengthSchema(
    schemas.Int32Schema
):
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'inUrl': typing.Union[InUrlSchema, str, ],
    }
)
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        'outUrl': typing.Union[OutUrlSchema, str, ],
        'cycleLength': typing.Union[CycleLengthSchema, decimal.Decimal, int, ],
...
request_query_in_url = api_client.QueryParameter(
    name="inUrl",
...
request_query_out_url = api_client.QueryParameter(
    name="outUrl",
    style=api_client.ParameterStyle.FORM,
    schema=OutUrlSchema,
    explode=True,
)
request_query_cycle_length = api_client.QueryParameter(
    name="cycleLength",
    style=api_client.ParameterStyle.FORM,
    schema=CycleLengthSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _check_stream_oapg(
        ...
        for parameter in (
            request_query_in_url,
            request_query_out_url,
            request_query_cycle_length,
...
class CheckStream(BaseApi):
    ...
    def check_stream(
        ...
        return self._check_stream_oapg(

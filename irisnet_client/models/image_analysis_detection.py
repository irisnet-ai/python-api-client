...
class ImageAnalysisDetection(Detection):
    """
    ...
    attributes: Optional[List[Attribute]] = Field(default=None, description="Attributes characterizing the _image_ detection.")

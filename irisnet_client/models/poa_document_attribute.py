...
class PoaDocumentAttribute(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="The document holder's name")
    document_type: Optional[StrictStr] = Field(default=None, description="The type of the document", alias="documentType")
    issuer: Optional[StrictStr] = Field(default=None, description="The issuer of the document")
    ...
    address_country: Optional[StrictStr] = Field(default=None, description="The document holders's address country in ISO 3166-1 alpha-2 format", alias="addressCountry")
    __properties: ClassVar[List[str]] = ["type", "name", "documentType", "issuer", "issuingDate", "address", "addressCountry"]

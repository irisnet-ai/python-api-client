...
class INParam(object):
    ...
    def in_class(self, in_class):
        ...
        :type: str
        """
        allowed_values = ["face", "child", "adult", "senior", "pose", "hand", "breast", "vulva", "penis", "vagina", "buttocks", "anus", "toy", "oral", "penetration", "foot", "footwear", "nudityCheck", "ageVerification", "ageEstimation", "illegalSymbols", "textRecognition"]  # noqa: E501

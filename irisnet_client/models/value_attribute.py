...
class ValueAttribute(Attribute):
    ...
    probability: Optional[StrictInt] = Field(default=None, description="The probability that the value matches the classification.")
    __properties: ClassVar[List[str]] = ["type", "classification", "value", "probability"]

...
class CheckResult(BaseModel):
    ...
    broken_rules: Optional[conlist(BrokenRule)] = Field(None, alias="brokenRules")
    detections: Optional[conlist(CheckResultDetectionsInner)] = None
    events: Optional[conlist(Event)] = None
    notifications: Optional[conlist(ApiNotice)] = None
    __properties = ["summary", "encodings", "brokenRules", "detections", "events", "notifications"]
    ...
    def from_dict(cls, obj: dict) -> CheckResult:
        ...
        _obj = CheckResult.parse_obj({
            ...
            "broken_rules": [BrokenRule.from_dict(_item) for _item in obj.get("brokenRules")] if obj.get("brokenRules") is not None else None,

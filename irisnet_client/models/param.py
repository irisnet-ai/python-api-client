...
class Param(BaseModel):
    ...
    prototype: Optional[StrictStr] = Field(default=None, description="The prototype that the classification object belongs to. Setting the prototype will specify the parameters for the classification belonging to the prototype.")
    ...
    def classification_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['nudityCheck', 'face', 'hand', 'foot', 'footwear', 'chest', 'breast', 'vulva', 'penis', 'vagina', 'buttocks', 'anus', 'oral', 'penetration', 'toy', 'bondage', 'gag', 'ageEstimation', 'child', 'adult', 'senior', 'pose', 'illegalSymbols', 'textRecognition', 'attributesCheck', 'female', 'male', 'hair', 'hairless', 'beard', 'moustache', 'headpiece', 'glasses', 'sunglasses', 'mask', 'slimSizedFace', 'realSizedFace', 'plusSizedFace', 'bodyAttributes', 'slimSized', 'realSized', 'plusSized', 'nippleCheck', 'noNipple', 'hasNipple', 'unwantedSubstances', 'beer', 'beerBottle', 'beerCan', 'wine', 'wineBottle', 'cocktail', 'alcohol', 'cannabis', 'cigarette', 'cocaine', 'heroine', 'coffee', 'violenceCheck', 'camouflage', 'club', 'knife', 'sword', 'pistol', 'rifle', 'cannon', 'fire', 'selfieCheck', 'hand2mouth', 'point2nose', 'relaxed', 'point2chin', 'hand2cheek', 'excellent', 'nice', 'thinking', 'thumbUp', 'victory', 'lookout', 'fingerUp', 'middleFinger', 'celebrityCheck', 'celebrity', 'advancedTextRecognition', 'text', 'textModeration', 'phoneNumber', 'socialHandle', 'email', 'website', 'badWord']):
            raise ValueError("must be one of enum values ('nudityCheck', 'face', 'hand', 'foot', 'footwear', 'chest', 'breast', 'vulva', 'penis', 'vagina', 'buttocks', 'anus', 'oral', 'penetration', 'toy', 'bondage', 'gag', 'ageEstimation', 'child', 'adult', 'senior', 'pose', 'illegalSymbols', 'textRecognition', 'attributesCheck', 'female', 'male', 'hair', 'hairless', 'beard', 'moustache', 'headpiece', 'glasses', 'sunglasses', 'mask', 'slimSizedFace', 'realSizedFace', 'plusSizedFace', 'bodyAttributes', 'slimSized', 'realSized', 'plusSized', 'nippleCheck', 'noNipple', 'hasNipple', 'unwantedSubstances', 'beer', 'beerBottle', 'beerCan', 'wine', 'wineBottle', 'cocktail', 'alcohol', 'cannabis', 'cigarette', 'cocaine', 'heroine', 'coffee', 'violenceCheck', 'camouflage', 'club', 'knife', 'sword', 'pistol', 'rifle', 'cannon', 'fire', 'selfieCheck', 'hand2mouth', 'point2nose', 'relaxed', 'point2chin', 'hand2cheek', 'excellent', 'nice', 'thinking', 'thumbUp', 'victory', 'lookout', 'fingerUp', 'middleFinger', 'celebrityCheck', 'celebrity', 'advancedTextRecognition', 'text', 'textModeration', 'phoneNumber', 'socialHandle', 'email', 'website', 'badWord')")
        return value

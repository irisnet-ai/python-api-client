...
class AiPrototype(BaseModel):
    """
    AiPrototype
    """ # noqa: E501
    name: Optional[StrictStr] = None
    classifications: Optional[List[AiClassification]] = None
    summary: Optional[StrictStr] = None
    aliases: Optional[List[StrictStr]] = None
    modes: Optional[List[StrictStr]] = None
    route: Optional[StrictStr] = None
    router_method: Optional[StrictStr] = Field(default=None, alias="routerMethod")
    depends_on: Optional[List[StrictStr]] = Field(default=None, alias="dependsOn")
    hidden: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "classifications", "summary", "aliases", "modes", "route", "routerMethod", "dependsOn", "hidden"]
    ...
    def route_validate_enum(cls, value):
        ...
        if value not in set(['AI_SERVICE', 'TEXT_SERVICE', 'PROVIDER_SERVICE']):
            raise ValueError("must be one of enum values ('AI_SERVICE', 'TEXT_SERVICE', 'PROVIDER_SERVICE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "classifications": [AiClassification.from_dict(_item) for _item in obj["classifications"]] if obj.get("classifications") is not None else None,
            "summary": obj.get("summary"),
            "aliases": obj.get("aliases"),
            "modes": obj.get("modes"),
            "route": obj.get("route"),
            "routerMethod": obj.get("routerMethod"),

...
class TextDetection(Detection):
    ...
    content: Optional[StrictStr] = Field(default=None, description="The text that was detected")
    attributes: Optional[List[Attribute]] = Field(default=None, description="Attributes characterizing the text.")
    sub_detections: Optional[List[BaseDetection]] = Field(default=None, description="A set of sub-detection for text moderation.", alias="subDetections")
    __properties: ClassVar[List[str]] = ["type", "classification", "group", "id", "probability", "coordinates", "content", "attributes", "subDetections"]

...
class BaseAttribute(BaseModel):
    ...
    __properties = ["classification", "probability", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseAttribute:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseAttribute:
        """Create an instance of BaseAttribute from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseAttribute.parse_obj(obj)

        _obj = BaseAttribute.parse_obj({

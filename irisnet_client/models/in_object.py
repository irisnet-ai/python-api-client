...
class INObject(object):
    ...
    @property
    def color(self):
        """Gets the color of this INObject.  # noqa: E501

        The color of the object, e.g. the color of the hair. Is only available for certain classification objects. See list below:  * _hair_ - black, brown, blonde, grey, red, other  # noqa: E501

        :return: The color of this INObject.  # noqa: E501
        :rtype: str
        """
        return self._color
    ...
    def color(self, color):
        """Sets the color of this INObject.

        The color of the object, e.g. the color of the hair. Is only available for certain classification objects. See list below:  * _hair_ - black, brown, blonde, grey, red, other  # noqa: E501

        :param color: The color of this INObject.  # noqa: E501
        :type: str
        """
        allowed_values = ["black", "brown", "blonde", "grey", "red", "other"]  # noqa: E501
        if self.local_vars_configuration.client_side_validation and color not in allowed_values:  # noqa: E501
            raise ValueError(
    ...
    @property
    def style(self):
        """Gets the style of this INObject.  # noqa: E501

        The style attribute of the object, e.g. the style of the hair. Is only available for certain classification objects. See list below:  * _hair_ - longHaired, shortHaired  # noqa: E501

        :return: The style of this INObject.  # noqa: E501
        :rtype: str
        """
        return self._style
    ...
    def style(self, style):
        """Sets the style of this INObject.

        The style attribute of the object, e.g. the style of the hair. Is only available for certain classification objects. See list below:  * _hair_ - longHaired, shortHaired  # noqa: E501

        :param style: The style of this INObject.  # noqa: E501
        :type: str
        """
        allowed_values = ["longHaired", "shortHaired"]  # noqa: E501

...
class PoaDocumentDetection(Detection):
    """
    ...
    processed_checks: Optional[PoaDocumentSubChecks] = Field(default=None, description="The sub-checks that were processed", alias="processedChecks")
    attributes: Optional[List[PoaDocumentAttribute]] = Field(default=None, description="Attributes of the _poaDocument_ detection.")
    document_holder_id: Optional[StrictStr] = Field(default=None, description="The id of the documentHolder", alias="documentHolderId")
    __properties: ClassVar[List[str]] = ["type", "classification", "group", "id", "probability", "coordinates", "checkId", "processedChecks", "attributes", "documentHolderId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "processedChecks": PoaDocumentSubChecks.from_dict(obj["processedChecks"]) if obj.get("processedChecks") is not None else None,
            "attributes": [PoaDocumentAttribute.from_dict(_item) for _item in obj["attributes"]] if obj.get("attributes") is not None else None,

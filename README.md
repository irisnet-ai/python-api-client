...
*AICheckOperationsApi* | [**check_poa_document**](docs/AICheckOperationsApi.md#check_poa_document) | **POST** /v2/check-poa-document/{configId} | Perform a proof of address check with the AI.
